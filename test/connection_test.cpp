...
TEST_F(ConnectionTest, Send) {
  web_server::message::Data data(reinterpret_cast<const std::uint8_t*>(m_read.data()),
                                 m_read.size(), 0);
